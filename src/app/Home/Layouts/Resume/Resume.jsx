    ...
    return (
        <section ref={setRefs} className="relative py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10 w-full overflow-hidden">
            ...
            <div className="text-center mb-20 animate-fadeInUp">
                ...
                <div className="p-5 inline-block bg-gradient-to-br from-bg-card to-bg-primary border border-border-color rounded-full shadow-custom text-accent mb-6 animate-float">
                    <FaBriefcase size={28} />
                </div>
