...
const ChatbotButton = ({ onClick, isOpen }) => (
    <button
        className={`fixed bottom-8 right-8 z-[999] w-16 h-16 rounded-full flex items-center justify-center shadow-custom transition-all duration-500 hover:scale-110 active:scale-95 group overflow-hidden ${
            isOpen 
